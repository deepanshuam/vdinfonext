    ...
    <div className={styles.dcard}>
        ...
        <div className={styles.gradient_cards}>
            <div className={styles.card}>
                <div className= {`${styles.container_card} ${styles.bg_green_box}`}>
                    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="118" height="118" rx="24" fill="url(#paint0_linear_1366_4547)" fillOpacity="0.15" stroke="url(#paint1_radial_1366_4547)" strokeWidth="2"></rect>
                    ...
                    <p className={styles.card_title}>Requirement Gathering</p>
                    <p className={styles.card_description}>We gather in-depth information on client goals, audience, and competitors to tailor a result-driven digital marketing strategy.</p>
                </div>
            </div>
            {/* 2 */}
            <div className={styles.card}>
                <div className={`${styles.container_card} ${styles.bg_white_box}`}>
                    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="118" height="118" rx="24" fill="url(#paint0_linear_1366_4565)" fillOpacity="0.15" stroke="url(#paint1_radial_1366_4565)" strokeWidth="2"></rect>
                    <ellipse rx="21.9462" ry="22.2891" transform="matrix(0.964749 0.263173 -0.254526 0.967066 60.1463 63.0804)" stroke="white" strokeWidth="1.00101" strokeLinecap="round" strokeDasharray="4 5.01"></ellipse>
                    ...
                    <p className={styles.card_description}> Our team creates wireframes and mockups, offering a visual representation of the campaign structure and digital assets.
                    </p>
                </div>
            </div>
            {/* 3 */}
            <div className={styles.card}>
                <div className={`${styles.container_card} ${styles.bg_yellow_box}`}>
                    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className={styles.card_title}>Prototype Demo</p>
                    <p className={styles.card_description}>We present a demo prototype of the strategy, ensuring client feedback is incorporated before full-scale development begins.</p>
                </div>
            </div>
            {/* 4 */}
            <div className={styles.card}>
                <div className={`${styles.container_card} ${styles.bg_white_box}`}>
                    ...
                    <p className={styles.card_title}>Changes and Confirmation</p>
                    <p className={styles.card_description}> We make necessary changes based on client input, finalizing the strategy and design for seamless execution.
                    </p>
                </div>
            </div>
            {/* 5 */}
            <div className={`${styles.container_card} ${styles.bg_yellow_box}`}>
                ...
                <p className={styles.card_title}>Development</p>
                <p className={styles.card_description}> Our developers and marketers bring the strategy to life, optimizing for SEO, PPC ads, and social media marketing.
                </p>
            </div>
            {/* 6 */}
            <div className={styles.card}>
                <div className={`${styles.container_card} ${styles.bg_blue_box}`}>
                    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className={styles.card_title}>Deployment</p>
                    <p className={styles.card_description}> We launch the campaign across platforms, including Google Ads, Facebook, and more, ensuring optimal performance and functionality.
                    </p>
                </div>
            </div>
            {/* 7 */}
            <div className={styles.card}>
                <div className={`${styles.container_card} ${styles.bg_white_box}`}>
                    ...
                    <p className={styles.card_title}>Support and Maintenance</p>
                    <p className={styles.card_description}> VD Infotech offers ongoing support, monitoring campaigns, optimizing SEO, and maintaining performance for long-term success.
                    </p>
                </div>
            </div>
            ...
            <div className={styles.card}>
                <div className= {`${styles.container_card} ${styles.bg_green_box}`}>
                    ...
                    <p className={styles.card_description}> We continuously enhance search engine optimization (SEO) to improve your website ranking, traffic, and lead generation.</p>
                </div>
            </div>
        </div>
    </div>
